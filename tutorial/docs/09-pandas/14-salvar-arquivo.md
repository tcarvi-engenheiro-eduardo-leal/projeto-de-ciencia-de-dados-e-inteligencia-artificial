...
selecaoFiltro1 = df['Quartos'] == 1
df[selecaoFiltro1]

selecaoFiltro2 = df['Valor'] < 1200
df[selecaoFiltro2]

selecaoFiltro3 = selecaoFiltro1 and selecaoFiltro2
df[selecaoFiltro3]

# Salvando ...
df.to_csv('dados_gerados.csv', index=False, sep=';') # Não cria um novo index
